...
class ModeloBlog{
    ...
    /*--=====================================
	Mostrar contenido de tabla categorias
	======================================*/
   ...
   /*-=====================================
    ...
    static public function mdlMostrarConInnerJoin($tabla1, $tabla2, $desde, $cantidad, $item, $valor){
        ...
        '%d.%m,%Y') AS fecha_articulo FROM $tabla1 INNER JOIN $tabla2 ON $tabla1.id_categoria = $tabla2.id_cat ORDER BY $tabla2.id_articulo 
    ...
    static public function mdlEnviarOpinion($tabla, $datos){
        ...
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_art, nombre_opinion, correo_opinion, foto_opinion, 
        contenido_opinion, fecha_opinion, id_adm) VALUES (:id_art, :nombre_opinion, :correo_opinion, :foto_opinion, :contenido_opinion,
        :fecha_opinion, :id_adm)");
    ...
    static public function mdlBuscador($tabla1, $tabla2, $desde, $cantidad, $busqueda){
        ...
        $tabla2.id_cat WHERE titulo_articulo like '%$busqueda%' OR descripcion_articulo like '%$busqueda%' OR 
        contenido_articulo like '%$busqueda%' OR ruta_articulo like '%$busqueda%' ORDER BY $tabla2.id_articulo
        DESC LIMIT $desde, $cantidad");
