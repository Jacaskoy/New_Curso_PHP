					...
					<div class="container p-0">
						...
						<div class="d-flex">
							...
							<div class="d-flex flex-column columna1">
								...
								background:url(<?php echo $categorias[4]["img_categoria"] ?>)">
							...
							<div class="d-flex flex-column flex-fill columna2">
								...
								<div class="d-block d-md-flex">
									...
									background:url(<?php echo $categorias[1]["img_categoria"] ?>)">
									...
									background:url(<?php echo $categorias[3]["img_categoria"] ?>)">
								...
								<figure class="p-2 m-0 photo5" vinculo="<?php echo $categorias[2]["ruta_categoria"] ?>"style="
									background:url(<?php echo $categorias[2]["img_categoria"] ?>)">
