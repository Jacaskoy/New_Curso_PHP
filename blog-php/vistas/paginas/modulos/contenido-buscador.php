...
/*--=====================================
 Revisar si viene paginacion de buscador
======================================*/
			...
			<?php foreach ($articulos as $key => $value): ?>
				...
				<div class="row">
					...
					<div class="col-12 col-lg-5">
						...
						<a href="<?php $blog["dominio"].$value["ruta_categoria"]."/".$value["ruta_articulo"];?>"><h5
						 class="d-block d-lg-none py-3"><?php $value["titulo_articulo"]; ?></h5></a>
			
						<a href="<?php $blog["dominio"].$value["ruta_categoria"]."/".$value["ruta_articulo"];?>"><img
						 src="<?php echo $blog["dominio"];?><?php echo $value["portada_articulo"];?>" alt="<?php 
						 $value["titulo_articulo"];?>" class="img-fluid" width="100%"></a>

					</div>

					<div class="col-12 col-lg-7 introArticulo">
						
						<a href="<?php echo $blog["dominio"].$value["ruta_categoria"]."/".$value["ruta_articulo"];?>"><h4
						 class="d-none d-lg-block w-75"><?php echo $value["titulo_articulo"]; ?></h4></a>
				...
				<div class="container d-none d-md-block">
					...
					echo $paginaActual; ?>" rutaPagina="<?php echo $rutas[0];?>" ></ul>
